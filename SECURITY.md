...
Chronogram is currently in an early open-source stage. Security fixes are prioritized for the latest mainline version of the repository.
...
- set `CHRONOGRAM_API_KEY` at minimum for non-health Chronogram routes
