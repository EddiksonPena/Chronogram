#!/usr/bin/env python3
"""Embedding model benchmark for Chronogram/ollama-cloud.
...
PERSIST_FILE = Path(os.environ.get(
    "CHRONOGRAM_DATA",
    "/home/eddiksonpena/projects/chronogram/data/chronogram-memory-os.json"
))
OUTPUT = Path("/home/eddiksonpena/projects/chronogram/data/benchmark-results.json")
...
def load_test_data():
    """Extract 10 content+query pairs from Chronogram memories."""
...
def main():
    print("═" * 60)
    print("  Embedding Model Benchmark — Chronogram / ollama-cloud")
    print("═" * 60)

    pairs = load_test_data()
    print(f"Test dataset: {len(pairs)} query-content pairs from Chronogram\n")
